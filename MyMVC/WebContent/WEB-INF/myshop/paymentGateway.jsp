...
$(document).ready(function() {
   ...
   IMP.request_pay({
       ...
       buyer_addr : '',  
       buyer_postcode : '',
       m_redirect_url : '192.168.50.48:9090/MyMVC/coinAddUpdateLoginuser.do?idx=${idx}'  // 휴대폰 사용시 결제 완료 후 action : 컨트롤러로 보내서 자체 db에 입력시킬것!
   }, function(rsp) {
       /*
		   if ( rsp.success ) {
			   var msg = '결제가 완료되었습니다.';
	   ...
	   */
		...
		*/
		...
		//	window.opener.goCoinUpdate('${idx}','${coinmoney}'); 	// 파라미터에 코인금액을 함께 보냈을 때
			window.opener.goCoinUpdate('${idx}');					// 파라미터에 인덱스값만 보냈을 때
